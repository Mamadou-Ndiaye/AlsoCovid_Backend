...
public interface PubMedRepository extends MongoRepository<PubMed,String> {
    ...
    public List<PubMed> findByTitreContainsIgnoreCase(@Param("titre") String titre);

    // Recuperer en fonction du date
    @RestResource(path = "/byDate")
    public List<PubMed> findByDateContainsIgnoreCase(@Param("annee") String annee);

  /*  // Recuperer en fonction du type
    @RestResource(path = "/byType")
    public List<PubMed> findByTypeContainsIgnoreCase(@Param("type") String type);

    // Recuperer en fonction du type et de la date
    @RestResource(path = "/byTypeAndDate")
    public List<PubMed> findByTypeContainsIgnoreCaseAndDateContainsIgnoreCase(@Param("type") String type,@Param("annee") String annee);
  */
